...
const UserListComponent = ()=>{
  ...
  useEffect(() => {
    if (authUser) {
        ...
        setPhoto(authUser.foto || defaultImage); // Imagen por defecto si está vacía
    }
}, [authUser]);
  ...
  const handleCancel = () => {
    setFormulario(authUser);
    setPhoto(authUser.foto || defaultImage);
    setEditField(null);
    setError({});
};
        ...
        <div className="div-perfil">
          <form className="form-perfil" >
           ...
           {editField === "foto" ? (
            ...
            <button className="button-change-confirm" onClick={()=>handleSave("nombre")}>Guardar</button>
            <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
            ...
            onChange={handleChange} /> 
            <button className="button-change-confirm" onClick={()=>handleSave("apellidos")}>Guardar</button>
            <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
            ...
            onChange={handleChange} /> 
            <button className="button-change-confirm" onClick={()=>handleSave("email")}>Guardar</button>
            <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
            ...
            onChange={handleChange} /> 
            <button className="button-change-confirm" onClick={()=>handleSave("localidad")}>Guardar</button>
            <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
            ...
            onChange={handleChange} /> 
            <button className="button-change-confirm" onClick={()=>handleSave("calle")}>Guardar</button>
            <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
            {error.calle && <span style={{color:"red"}}>{error.calle} </span>}
              ...
              onChange={handleChange} /> 
              <button className="button-change-confirm" onClick={()=>handleSave("numero")}>Guardar</button>
              <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
              ...
              onChange={handleChange} /> 
              <button className="button-change-confirm" onClick={()=>handleSave("codigoPostal")}>Guardar</button>
              <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
              ...
              onChange={handleChange} /> 
              <button className="button-change-confirm" onClick={()=>handleSave("numeroTarjeta")}>Guardar</button>
              <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
              ...
              onChange={handleChange} /> 
              <button className="button-change-confirm" onClick={()=>handleSave("caducidad")}>Guardar</button>
              <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
              ...
              onChange={handleChange} /> 
              <button className="button-change-confirm" onClick={()=>handleSave("password")}>Guardar</button>
              <button className="button-change-cancel" onClick={handleCancel}>Cancelar</button>
              ...
              <div className="div-delete-user">
                <button className="button-delete-user" onClick={deleteUser}>Eliminar Cuenta</button>
              </div>
            </form>
        </div>
      </section>
