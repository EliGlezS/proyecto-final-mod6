      ...
      <div className="login-container">
        <NavLink to={!isLoggedIn ? `/login` : `/perfil`} onClick={closeNav}>
          <div className="icon-container" title="Mi cuenta">
            {/* Mostrar la foto de perfil o imagen por defecto */}
            <img
              className="user-img"
              src={authUser?.foto || <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
